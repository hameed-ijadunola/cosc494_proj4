...
def generate_launch_description():
    ...
    proj4_share = get_package_share_directory("proj4")
    ...
    default_rviz = os.path.join(mushr_desc_share, "rviz", "proj4.rviz")
    default_map = os.path.join(proj4_share, "maps", "map3.yaml")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("initial_x", default_value="16.0", description="Initial x position"),
            DeclareLaunchArgument("initial_y", default_value="28.0", description="Initial y position"),
